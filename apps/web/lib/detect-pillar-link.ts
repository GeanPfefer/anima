export type DetectedLink = {
  childName:  string;  // área específica (filho)
  parentName: string;  // área que contém (pai)
};

// Detecta agrupamentos declarados na conversa ("teclado e violão são música",
// "música é lazer"). Conservador: só relações explícitas de "faz parte de".
