...
export const sameReviewReceipt=(left:ReviewRequestReceipt,right:ReviewRequestReceipt):boolean=>left.kind===right.kind&&left.receiptId===right.receiptId&&left.idempotencyKey===right.idempotencyKey&&left.providerId===right.providerId&&left.repositoryId===right.repositoryId&&left.remoteName===right.remoteName&&left.reviewId===right.reviewId&&left.reviewReference===right.reviewReference&&left.state===right.state&&left.sourceBranch===right.sourceBranch&&left.sourceCommitSha===right.sourceCommitSha&&left.baseBranch===right.baseBranch&&left.verifiedBaseSha===right.verifiedBaseSha;
