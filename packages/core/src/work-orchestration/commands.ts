import type { ApprovalDecision, ProposalVersion, SourceMessageId, WorkCapability, WorkImpactLevel, WorkIntent, WorkItemId, WorkProposal, WorkResultInput } from './types';
