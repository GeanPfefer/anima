...
> Documento vivo de design. Última atualização: 2026-08-24 (sessão: primeira E2E do Project Advisor Item Drill-down V0 encerrada antes do provider por isolamento RLS do item-fixture; erro 404 agora é apresentado de forma compreensível; ver [registro](docs/registros/2026-08-24-project-advisor-item-drilldown-v0-e2e.md) e [Plano 002](docs/planos/002-modo-autonomo-v0.md))
