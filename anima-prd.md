...
> Documento vivo de design. Última atualização: 2026-08-24 (sessão: Project Advisor V0 comprovado pela UI real com contexto governado read-only, autoridade/proveniência, structured output OpenAI e validação semântica fail-closed; ver [registro](docs/registros/2026-08-24-project-advisor-v0.md) e [Plano 002](docs/planos/002-modo-autonomo-v0.md))
