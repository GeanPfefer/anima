...
> Documento vivo de design. Última atualização: 2026-08-26 (sessão: preparação real de elegibilidade do novo ServedRead V1 comprovada pela fila autenticada, sem claim/attempt/request; ver [registro](docs/registros/2026-08-26-preparacao-elegibilidade-servedread-v1.md) e [Plano 002](docs/planos/002-modo-autonomo-v0.md))
