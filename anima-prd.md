...
> Documento vivo de design. Última atualização: 2026-08-26 (sessão: evidência terminal passa a gerar decisão determinística de recovery; Item 1 real classificado como decomposição; ver [registro](docs/registros/2026-08-26-classificacao-deterministica-de-recovery.md) e [Plano 002](docs/planos/002-modo-autonomo-v0.md))
