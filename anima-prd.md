...
> Documento vivo de design. Última atualização: 2026-08-24 (sessão: Project Advisor Item Drill-down V0 comprovado localmente com resolução conservadora e projeção read-only por item; ver [registro](docs/registros/2026-08-24-project-advisor-item-drilldown-v0.md) e [Plano 002](docs/planos/002-modo-autonomo-v0.md))
