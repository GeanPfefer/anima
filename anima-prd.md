...
> Documento vivo de design. Última atualização: 2026-08-24 (sessão: Project Advisor Fresh Operational State V1 comprovado localmente com projeção viva read-only, temporalidade explícita e triagem governada; ver [registro](docs/registros/2026-08-24-project-advisor-fresh-operational-state-v1.md) e [Plano 002](docs/planos/002-modo-autonomo-v0.md))
